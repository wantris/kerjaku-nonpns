	...
	<div class="navbar-custom-menu">
		<ul class="nav navbar-nav">
			...
			<li class="dropdown user user-menu">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">
					<img src="<?= base_url('assets/uploads/images/foto_profil/' . $data['userdata']->photo); ?>" class="user-image">
					<span class="hidden-xs"><?= $data['userdata']->first_name; ?> <?= $data['userdata']->last_name; ?></span>
				</a>
				<ul class="dropdown-menu">
					<!-- User image -->
					<li class="user-header">
						<img src="<?= base_url('assets/uploads/images/foto_profil/' . $data['userdata']->photo); ?>" class="img-circle">
						<p>
							<?= $data['userdata']->email; ?>
							<small>Terakhir Masuk , <?= $data['userdata']->last_login; ?></small>
						</p>
					</li>
					<!-- Menu Footer-->
