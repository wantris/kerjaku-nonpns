        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="<?php echo site_url('Pegawai/aktivitas/edit/' . $item->id_ak) ?>" class="btn btn-primary" style="margin-right: 10px;">Edit</a>
                                                <a href="<?php echo site_url('Pegawai/aktivitas/delete/' . $item->id_ak) ?>" class="btn btn-danger">Hapus</a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php
                ...
                <div class="tab-pane" id="password">
                    <div class="box-header">
                        <h3 class="box-title font-weight-bold">Tambah Aktivitas</h3>
                    </div>
                    <div class="box-body">
